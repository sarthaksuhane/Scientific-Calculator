...
bksp = Button(root, text="Delete", padx=18, pady=10, relief=RAISED, bg="Dark Red", fg="White",command=lambda: bksps())
...
four = Button(root, text="4", padx=30, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("4"))
five = Button(root, text="5", padx=29, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("5"))
six = Button(root, text="6", padx=29, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("6"))
...
one = Button(root, text="1", padx=30, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("1"))
two = Button(root, text="2", padx=29, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("2"))
three = Button(root, text="3", padx=29, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("3"))
plus = Button(root, text="+", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("+"))

e_b = Button(root, text="e", padx=29, pady=10, relief=RAISED, bg="Black", fg="White")
e_b.bind("<Button-1>", sc)
zero = Button(root, text="0", padx=29, pady=10, relief=RAISED, bg="Light Green", fg="Black",command=lambda: click("0"))
